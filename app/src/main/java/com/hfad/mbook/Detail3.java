...
public class Detail3 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view = inflater.inflate(R.layout.fragment_detail3, container, false);
        //attaching checkbox
        CheckBox checkBox1 = (CheckBox) view.findViewById(R.id.checkbox3);
        checkBox1.setOnClickListener(listener);
        try {
            SQLiteOpenHelper helper = new mBookData(inflater.getContext());
            db = helper.getReadableDatabase();
            //getting data
            cursor = db.query("DATA", new String[]{"STORY", "VALUE"}, "NAME=?", new String[]{"My Big Book Of Action Stickers"},
                    null, null, null);
            //navigating cursor
        ...
        TextView textView = (TextView) view.findViewById(R.id.detail3);
    ...
    public void check3() {
        ...
        try {
            ...
            db.update("DATA", values, "NAME=?", new String[]{"My Big Book Of Action Stickers"});
        } catch (SQLiteException e) {
            e.printStackTrace();
        }
    }
